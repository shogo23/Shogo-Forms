...
$_SESSION['success_settings'] = json_decode( $meta['success_settings'][0], true );
...
<div class="SF_admin_cf_container">
	<div class="SF_admin_cf_name_container">
		...
		<input type="text" class="SF_admin_cf_form_name" disabled="disabled" value="<?php echo $form_name; ?>" />
	</div>
  ...
  <div class="SF_btns">
    <span class="SF_admin_ajax_loader">
      <img src="/wp-content/plugins/shogo-forms/img/ajax-loader.gif" />
    </span>
    <span class="button-primary SF_btn_save">Save</span>
    <span class="button-primary SF_btn_clear">Clear All</span>
  </div>
</div>
...
<script type="text/javascript">
  ...
  //Scroll down once user add a field.
    ...
    jQuery(".SF_admin_ajax_loader").show();
    ...
    jQuery.post(ajaxurl, data, function( r ) {
      ...
      if ( r !== "ok" ) {
        ...
        jQuery(".SF_admin_ajax_loader").hide();
        ...
        //Ajax Properties.
        jQuery.post(ajaxurl, data2, function() {
